...
//十个自带颜色
#define RING_COLOR_ARR(R) @[kColor(204, 40, 44, R),kColor(242, 144, 75, R),kColor(88, 197, 245, R),kColor(255, 211, 57, R),kColor(0, 164, 171, R),kColor(0, 121, 176, R),kColor(49, 58, 134, R),kColor(139, 42, 125, R),kColor(228, 55, 117, R),kColor(45, 103, 51, R)]
...
//要不要环图间隔
@property (nonatomic, assign) BOOL hasSpace;
//环图间隔 单位为π
