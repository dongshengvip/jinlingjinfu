...
- (CAShapeLayer *)backLayer {
    if (!_backLayer) {
        ...
        _backLayer.frame = CGRectMake(0,0, ZZCircleSelfWidth - _strokeWidth/2, ZZCircleSelfHeight - _strokeWidth/2);
        ...
        UIBezierPath *backCirclePath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(ZZCircleSelfWidth/2.0, ZZCircleSelfHeight) radius:_realWidth/2.0 - _strokeWidth/2 startAngle:_startAngle endAngle:(2*M_PI-_reduceAngle+_startAngle) clockwise:YES];
...
- (CAShapeLayer *)progressLayer {
    if (!_progressLayer) {
        ...
        _progressLayer.frame = CGRectMake(0,0, ZZCircleSelfWidth - _strokeWidth/2, ZZCircleSelfHeight - _strokeWidth/2);
        ...
        UIBezierPath *circlePath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(ZZCircleSelfWidth/2.0, ZZCircleSelfHeight) radius:_realWidth/2.0 - _strokeWidth/2 startAngle:_startAngle endAngle:(2*M_PI-_reduceAngle+_startAngle) clockwise:YES];
...
- (UIImageView *)pointImage {
    if (!_pointImage) {
        ...
        CGFloat realWidth = ZZCircleSelfWidth;
        _pointImage.frame = CGRectMake(0, 0, _strokeWidth, _strokeWidth);
        //定位起点位置
        CGPoint shouldPoint = CGPointMake(_realWidth/2.0+(realWidth/2.0)*cosf(_startAngle), ZZCircleSelfHeight/2.0+(realWidth/2.0)*sinf(_startAngle));
...
- (void)startAnimation {
    ...
    if (_showPoint) {
        ...
        CGPathAddArc(curvedPath, NULL, _realWidth/2.0, _realWidth/2.0, _realWidth/2.0 - _strokeWidth/2, _increaseFromLast==YES?(2*M_PI-_reduceAngle)*_lastProgress+_startAngle:_startAngle, (2*M_PI-_reduceAngle)*_progress+_startAngle, shouldNot);
